...
public class NumberSettingRender extends SettingRender<NumberSetting> {
    ...
    public void render(float x, float y, float width, float height, float mouseX, float mouseY, boolean custom) {
        ...
        Render2DUtils.drawOptimizedRoundedRect(x + 16 + fw, y + 3, 160f, 6f, FPSMaster.theme.getFrontBackground().getRGB());
        ...
        Render2DUtils.drawOptimizedRoundedRect(x + 16 + fw, y + 3, aWidth, 6f, FPSMaster.theme.getPrimary().getRGB());
