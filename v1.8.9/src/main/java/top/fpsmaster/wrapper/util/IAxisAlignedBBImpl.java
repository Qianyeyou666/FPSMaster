...
import top.fpsmaster.interfaces.game.IAxisAlignedBBWrapper;

public class IAxisAlignedBBImpl implements IAxisAlignedBBWrapper {
    AxisAlignedBB axisAlignedBB;

    public IAxisAlignedBBImpl(AxisAlignedBB axisAlignedBB) {
        this.axisAlignedBB = axisAlignedBB;
    }

    public IAxisAlignedBBImpl(double x, double y, double z, double x1, double y1, double z1) {
    ...
    public IAxisAlignedBBImpl expand(double x, double y, double z){
    ...
    @NotNull
    public IAxisAlignedBBImpl addCoord(double x, double y, double z) {
